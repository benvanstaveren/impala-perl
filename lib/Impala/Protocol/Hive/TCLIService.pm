...
use Impala::Protocol::Hive::Types;

# HELPER FUNCTIONS AND STRUCTURES

package
	Impala::Protocol::Hive::TCLIService_OpenSession_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_OpenSession_args->mk_accessors( qw( req ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TOpenSessionReq();
...
package
	Impala::Protocol::Hive::TCLIService_OpenSession_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_OpenSession_result->mk_accessors( qw( success ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TOpenSessionResp();
...
package
	Impala::Protocol::Hive::TCLIService_CloseSession_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CloseSession_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TCloseSessionReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_CloseSession_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CloseSession_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TCloseSessionResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetInfo_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetInfo_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetInfoReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetInfo_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetInfo_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetInfoResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_ExecuteStatement_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_ExecuteStatement_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TExecuteStatementReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_ExecuteStatement_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_ExecuteStatement_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TExecuteStatementResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTypeInfo_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTypeInfo_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetTypeInfoReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTypeInfo_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTypeInfo_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetTypeInfoResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetCatalogs_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetCatalogs_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetCatalogsReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetCatalogs_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetCatalogs_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetCatalogsResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetSchemas_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetSchemas_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetSchemasReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetSchemas_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetSchemas_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetSchemasResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTables_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTables_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetTablesReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTables_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTables_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetTablesResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTableTypes_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTableTypes_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetTableTypesReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetTableTypes_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetTableTypes_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetTableTypesResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetColumns_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetColumns_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetColumnsReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetColumns_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetColumns_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetColumnsResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetFunctions_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetFunctions_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetFunctionsReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetFunctions_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetFunctions_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetFunctionsResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetOperationStatus_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetOperationStatus_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetOperationStatusReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetOperationStatus_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetOperationStatus_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetOperationStatusResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_CancelOperation_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CancelOperation_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TCancelOperationReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_CancelOperation_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CancelOperation_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TCancelOperationResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_CloseOperation_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CloseOperation_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TCloseOperationReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_CloseOperation_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_CloseOperation_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TCloseOperationResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetResultSetMetadataReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetResultSetMetadataResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_FetchResults_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_FetchResults_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TFetchResultsReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_FetchResults_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_FetchResults_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TFetchResultsResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetLog_args;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetLog_args->mk_accessors( qw( req ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{req} = new Impala::Protocol::Hive::TGetLogReq();
        $xfer += $self->{req}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIService_GetLog_result;
use base qw(Class::Accessor);
Impala::Protocol::Hive::TCLIService_GetLog_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Impala::Protocol::Hive::TGetLogResp();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package
	Impala::Protocol::Hive::TCLIServiceIf;
...
package
	Impala::Protocol::Hive::TCLIServiceRest;
...
sub GetLog{
  ...
  my $req = ($request->{'req'}) ? $request->{'req'} : undef;
  return $self->{impl}->GetLog($req);
}

package
	Impala::Protocol::Hive::TCLIServiceClient;
...
sub send_OpenSession{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_OpenSession_args();
  $args->{req} = $req;
...
sub recv_OpenSession{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_OpenSession_result();
...
sub send_CloseSession{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_CloseSession_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_CloseSession{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_CloseSession_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetInfo{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetInfo_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetInfo{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetInfo_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_ExecuteStatement{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_ExecuteStatement_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_ExecuteStatement{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_ExecuteStatement_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetTypeInfo{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetTypeInfo_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetTypeInfo{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetTypeInfo_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetCatalogs{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetCatalogs_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetCatalogs{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetCatalogs_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetSchemas{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetSchemas_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetSchemas{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetSchemas_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetTables{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetTables_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetTables{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetTables_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetTableTypes{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetTableTypes_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetTableTypes{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetTableTypes_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetColumns{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetColumns_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetColumns{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetColumns_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetFunctions{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetFunctions_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetFunctions{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetFunctions_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetOperationStatus{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetOperationStatus_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetOperationStatus{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetOperationStatus_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_CancelOperation{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_CancelOperation_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_CancelOperation{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_CancelOperation_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_CloseOperation{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_CloseOperation_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_CloseOperation{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_CloseOperation_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetResultSetMetadata{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetResultSetMetadata{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetResultSetMetadata_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_FetchResults{
  ...
  my $args = new Impala::Protocol::Hive::TCLIService_FetchResults_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_FetchResults{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_FetchResults_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetLog{
  ...
  $self->{output}->writeMessageBegin('GetLog', TMessageType::CALL, $self->{seqid});
  my $args = new Impala::Protocol::Hive::TCLIService_GetLog_args();
  $args->{req} = $req;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetLog{
  ...
  my $result = new Impala::Protocol::Hive::TCLIService_GetLog_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetLog failed: unknown result";
}
package
	Impala::Protocol::Hive::TCLIServiceProcessor;
...
sub process_GetLog {
    ...
    $input->readMessageEnd();
    my $result = new Impala::Protocol::Hive::TCLIService_GetLog_result();
    $result->{success} = $self->{handler}->GetLog($args->req);
